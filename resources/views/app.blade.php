...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" @class(['dark' => ($appearance ?? 'system') == 'dark'])>
    <head>
        ...
        <meta name="description" content="VibezSync is a social media scheduling and content management platform that allows creators and businesses to plan, schedule, and publish posts across multiple platforms, including TikTok, Instagram, and YouTube.">
