...
export function RegisterForm({
    ...
    const { post, processing, errors, data, setData, setError } = useForm({
        phone: "",
        password: "",
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col items-center gap-2">
                        ...
                        >
                            ...
                            <span className="sr-only">Starpick.</span>
                        </a>
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="grid gap-1">
                            ...
                            />
                            {globalErrors.username && (
                                <FormError message={globalErrors.username} />
                            )}
                        </div>
                        <div className="grid gap-1">
