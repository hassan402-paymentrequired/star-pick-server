        ...
        <MainLayout>
            ...
            <div className="space-y-4 p-5">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {/* Preview */}
                    <Card className="bg-background p-4 gap-3 rounded border-[var(--clr-primary-a0)]">
                        <CardHeader className="p-0">
                    ...
                    {/* Wallet Info */}
                    <Card className="bg-background rounded border-border">
                    ...
                    <div className="space-y-3">
                        <Button
                            type="submit"
                            className="w-full tracking-wider text-background"
